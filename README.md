...
Power supply voltage - single (V)	1.8, 2.5, 3.3, 5  
Protocols	Analog  
Ron (typ) (Ω)	60  
CON (typ) (pF)	50  
ON-state leakage current (max) (µA)	8  
Bandwidth (MHz)	89  
Input/output continuous current (max) (A)	0.025  
...
# Features  
Overall diameter: ~22mm - 23.7mm  
Overall height: 15mm  
Large Ball Diameter: 12mm  
